...
import main.Actualizar_Estudiante;
 ...
 * @author JORGE
 */
public class Tabla_Estudiante extends javax.swing.JPanel {

    Empleado emp; //declara un objeto emp de la clase Empleado
    //  File archi;
    DefaultTableModel dtm = new DefaultTableModel();
    int clickTabla;
    public static String estudiante_update = "";
    
    public static boolean masculino = false;
    public static boolean femenino = false;
    
    public static boolean tutor1 = false;
    public static boolean tutor2 = false;

    public Tabla_Estudiante() {
        initComponents();
    ...
    public void mostrarEstudiantes(){
      Connection conexion = null;
        try {
            ...
            empleado.visualizar_Estudiante(tablaEmpleados);
//        tablaEmpleados.setModel(modelo);
        ...
        try {
            ...
            if (cargo != null) {
                if ("Regente(a)".equals(cargo)) {
                    ...
                    Actualizar_Estudiante estudiante_update_ = new Actualizar_Estudiante();
                    estudiante_update_.setVisible(true);
                }
            }else{
            ...
            mensajeError(" Error en la conexion con la base de datos "+ex);
        }
    }
    
    public void estudiante(String ci) {
        String genero;
        int tutor;
        try {
    ...
    private void initComponents() {
        ...
        logoname.setText("    TABLA DE ESTUDIANTES");
    ...
    private void tablaEmpleadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaEmpleadosMouseClicked
        ...
        try {
            if (evt.getClickCount() == 1) {
                estudiante_update = tablaEmpleados.getValueAt(tablaEmpleados.getSelectedRow(), 1).toString();
